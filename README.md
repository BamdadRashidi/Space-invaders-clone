...
- A wave selector: at the start of the game, you can choose which wave are you going to start on so that you don't have to always start from wave 1. however keep in mind that you have to unlock that wave first by reaching double of that said wave.
...
## Credits
Programming, Design, Pixel Art, Animation, Music, SFX, Testing, Direction and Planning: MohammadAmin "Bamdad" Rashidi.
